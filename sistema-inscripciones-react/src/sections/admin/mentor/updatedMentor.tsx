...
interface UpdatedMentorFormProps {
  id: string
  onUpdateComplete: () => void
}

export default function UpdatedMentorForm({
  id,
  onUpdateComplete,
}: UpdatedMentorFormProps) {
  ...
  const URL = "http://localhost:4000/api/v1/admin/mentor/"
  ...
  return (
    <section className="grid place-content-center bg-gray-100 p-1">
      ...
      >
        <h2 className="text-2xl font-bold text-center">Actualizar Mentor</h2>
      ...
      {response && (
        <p className="mt-4 text-green-500">Mentor actualizado con éxito</p>
      )}
    </section>
  )
}
